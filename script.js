    ...
    with(ctx) {
        ...
        for(i=0;i<snake_head[0].length;i++) {
            beginPath();
                ...
                moveTo(board_width*(snake_head[0][i]/100), board_width*(snake_head[1][i]/100));
                lineTo(board_width*(snake_tail[0][i]/100), board_width*(snake_tail[1][i]/100));
                stroke();
            closePath();
        }
    }    
...
var Roll =()=> {
    ...
    //console.log(second_ver_head.length);
